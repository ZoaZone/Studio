...
/**
 * getRenderStatus — polls the standalone render worker for a job's current
 * status, on behalf of the frontend (which never talks to the worker or
 * its shared secret directly).
 *
