...
/**
 * getLane1VideoStatus — polls the standalone render worker for a Lane 1
 * short-video assembly job's current status, on behalf of the frontend
 * (which never talks to the worker or its shared secret directly).
 *
 ...
 * worker is shared by every job kind.
 */
